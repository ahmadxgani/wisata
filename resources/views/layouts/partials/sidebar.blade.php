<x-mazer-sidebar :href="route('dashboard')" :logo="asset('assets/static/images/logo/logo.png')">
    ...
    <x-mazer-sidebar-item icon="bi bi-database-fill" :link="route('category')" name="Category"/>
    <x-mazer-sidebar-item icon="bi bi-person-circle" :link="route('dashboard')" name="Account">
